   ...
   <main>
       ...
       <div class="content-main">
            ...
            <section class="profile-set">
                ...
                <form class="size formAccount" action="send.php" method="post">
                    <label class="label-mail required" for="mail">E-mail<span> *</span></label>
                    <label style="position: relative;">
                        <input class="email" type="email" name="mail" id="mail" value="mingalyovuxcheck@gmail.com" required>
                    ...
                    <div class="phone">
                        <div class="size-input">
                            ...
                            <label style="position: relative;">
                                <input class="first-tel required" type="tel" name="tel" id="tel" value="+7 910 832 26 28" required>
                    ...
                    <label style="position:relative;">
                        <input class="required" type="text" name="surname" id="surname" value="Мингалёв">
                        <img src="Icon.svg" class="img-gal" >
                    </label> 
